...
import { AlignJustify, Cross, Hamburger, X } from "lucide-react";
...
export default function SideBar({
  ...
  return (
    <div className="fixed top-[85px] left-3 rounded-lg shadow-[0px_0px_10px_3px_rgba(255,255,255,0.4)] z-10">
      <form
        onSubmit={(e) => {
          handleJobFilterForm(e), setIsSidebarOpen(false);
        }}
