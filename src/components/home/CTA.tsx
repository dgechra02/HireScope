    ...
    <div className="flex w-[95%] bg-[#212121] rounded-2xl border border-[#3a3a3a] py-4 md:py-8 lg:py-12 xl:py-20 h-fit"> 
      <div className="content w-[90%] sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[60%] flex flex-col items-center gap-3 lg:gap-7 m-auto">
        ...
        <div className="max-lg:flex-col flex gap-3 lg:gap-5 mt-2 lg:h-20 items-center">
          <Link href={'/sign-up'} className="text-black font-semibold text-sm lg:text-xl bg-white py-3 px-5 h-10 lg:h-15 cursor-pointer rounded-lg flex gap-2 items-center hover:-translate-y-1 transition-transform duration-500">
            Create Your Profile
          </Link>
          <Link href={'/job-search'} className="text-gray-400 hover:text-white font-semibold text-sm lg:text-xl hover:bg-[#212121] py-3 px-5 h-10 lg:h-15 cursor-pointer rounded-lg flex gap-2 items-center border border-[#3a3a3a] hover:-translate-y-1 transition-all duration-500">
            Browse Jobs
          </Link>
        </div>
      </div>
