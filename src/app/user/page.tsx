      ...
      <div className="main flex flex-col gap-5 w-[95%] m-auto">
        ...
        <div className="flex gap-5 ">
          ...
          <div className="actions flex flex-col gap-2 p-7 bg-[#161616] border rounded-lg border-[#3a3a3a] flex-1">
            ...
            <button className="border border-[#525252] rounded py-2 px-4 w-fit font-semibold hover:bg-white hover:text-black transition-all duration-500 h-12"> 📄 Add Resume </button>
            <button className="border border-[#525252] rounded py-2 px-4 w-fit font-semibold hover:bg-white hover:text-black transition-all duration-500 h-12"> 🏢 Add Company </button>
            <button className="border border-[#525252] rounded py-2 px-4 w-fit font-semibold hover:bg-white hover:text-black transition-all duration-500 h-12"> ✏️ Edit Profile </button>
            <button className="border border-[#525252] rounded py-2 px-4 w-fit font-semibold hover:bg-white hover:text-black transition-all duration-500 h-12"> 🗑️ Delete Company </button>
            </div>
            {/* {user?.success && (
              <button
